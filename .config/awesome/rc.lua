...
beautiful.init("/home/bcforres/.config/awesome/themes/default/theme.lua")
...
tags = {
   names  = { "term", "www", "mpd", "mail", 5, 6, 7, 8, 9 },
...
kbdcfg.layout = { { "dvorak", "" }, { "us", "" } }
kbdcfg.current = 1  -- dvorak is our default layout
...
kbdcfg.switch = function ()
  ...
  os.execute("xmodmap /home/bcforres/.xmodmap")
end
...
batterybox:set_align("right")
--batterybox.text = "1337"
...
batterybox:set_markup("Bat: "..get_battery_status());


batterybox.text = get_battery_status()
battery_timer = timer({ timeout = 60 })
battery_timer:connect_signal("timeout", function() batterybox:set_markup("Bat: "..get_battery_status()) end)
battery_timer:start()
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ "Mod1" }, "F12", function () kbdcfg.switch() end),
    ...
    awful.key({ "Mod4" }, "F3", function()
                            awful.util.spawn("amixer sset 'Master' 1%+") end),
